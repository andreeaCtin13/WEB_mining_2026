...
grid_search = GridSearchCV(tree_reg, param_grid=param_grid, scoring="neg_mean_squared_error")

# 6. Fit the grid search on the training set
x_train_fit = grid_search.fit(X_train, y_train)
y_train_fit = grid_search.predict(X_train)
